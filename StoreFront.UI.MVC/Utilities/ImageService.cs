...
namespace MVC3.UI.MVC.Utilities
{
    ...
    {//docx or pdf you dont need this utility
        ...
        public static void Delete(string path, string fileName)
        {
            ...
            //******to match YOUR CURRENT DEFAULT IMAGE NAME (ie, if you ahve default.jpg as your image)*****
            //*****update teh if to reflect the: if (fileName.ToLower() == "default.jpg") below
            //************************************************************************************
